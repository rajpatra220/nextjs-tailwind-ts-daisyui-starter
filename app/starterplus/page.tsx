  ...
  return (
      <div className="w-full flex flex-col gap-10 items-center justify-center m-auto p-5">
        ...
        <div className="bg-base-200 p-8 rounded-xl shadow-lg border-1 border-base-content/10">
          ...
          <h2 className="text-2xl font-bold"># Starter Plus</h2>
          <div className="flex justify-center my-5">
            <p className="text-sm">
              This is a starter for building modern web applications using <b>Next.js</b>, <b>Tailwind CSS</b> and <b>TypeScript</b> with <b>daisyUI</b>.<br/>
              It is pre-configured with a theme switcher to toggle between the default <a href="https://daisyui.com/docs/themes/#list-of-themes" className="link font-bold">themes</a> provided by daisyUI.
              <br/><br/>
              This version also includes a <b>Navbar</b> and <b>Footer</b> components to enhance the layout and navigation of your application.<br/>
              You can easily customize the components to fit your application needs.
            </p>
          </div>
          <div>
            <ul className="list bg-base-100 rounded-box shadow-md border-1 border-base-content/10">
              ...
              <li className="list-row">
                ...
                <button className="btn btn-square btn-ghost">
                  <Link href="/"><svg className="size-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="list-row">
                ...
                <button className="btn btn-square btn-ghost">
                  <Link href="/starterplus"><svg className="size-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor">
                    <path d="M10 16H7C4.79086 16 3 14.2091 3 12V12C3 9.79086 4.79086 8 7 8H10"/>
                    <path d="M16 12H8"/>
                    <path d="M14 16H17C19.2091 16 21 14.2091 21 12V12C21 9.79086 19.2091 8 17 8H14"/>
              ...
              <li className="list-row">
                ...
                <button className="btn btn-square btn-ghost">
                  <Link href="/adminstarter"><svg className="size-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor">
                    <path d="M10 16H7C4.79086 16 3 14.2091 3 12V12C3 9.79086 4.79086 8 7 8H10"/>
                    <path d="M16 12H8"/>
                    <path d="M14 16H17C19.2091 16 21 14.2091 21 12V12C21 9.79086 19.2091 8 17 8H14"/>
          ...
          <div className="flex justify-around mt-5">
            <button className="btn btn-sm btn-primary font-bold rounded">
              <Link href="https://github.com/rajpatra220/nextjs-tailwind-ts-daisyui-starter" target="_blank" className="flex gap-2 items-center">
